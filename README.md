...
CropTwin is a cloud-based digital twin platform that generates farm-level crop advisories using publicly available data (weather, satellite, soil) — without requiring expensive IoT sensors.
It is designed for smallholder farmers in low-connectivity regions, with support for SMS, IVR, and mobile apps.
...
Crop calendars
It then:
Simulates crop conditions
Detects risks
Sends personalized advisories
No sensors required.
...
S3 – satellite and historical data
AppSync – GraphQL API
...
Monitor
aws cloudwatch get-dashboard --dashboard-name CropTwin


📊 Impact Potential
Target: 100,000+ smallholder farmers
Cost: <$0.10 per farmer per month
